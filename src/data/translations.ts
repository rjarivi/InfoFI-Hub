...
export const translations = {
  en: {
    ...
    tryDifferentCategory: "Try selecting a different category or check back later.",
  ...
  es: {
    ...
    active: "Activo",
    platform: "Plataforma",
    claimPeriod: "Período de Reclamo",
    ...
    tryDifferentCategory: "Intenta seleccionar una categoría diferente o vuelve más tarde.",
  ...
  fr: {
    ...
    active: "Actif",
    platform: "Plateforme",
    claimPeriod: "Période de Réclamation",
